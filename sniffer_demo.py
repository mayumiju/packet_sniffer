...
# Return properly formatted MAC address (ie AA:BB:CC:DD:EE:FFS)
...
def tcp_segment(data):
    ...
    return src_port, dest_port, sequence, acknowledgement, flags_ack, flags_fin, flags_psh, flags_rst, flags_syn, flags_urg, data[offset:]
